...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='D:\yolov5\models\plane.yaml', help='model.yaml path')
    ...
    parser.add_argument('--evolve', type=int, nargs='?', const=101, help='evolve hyperparameters for x generations')
